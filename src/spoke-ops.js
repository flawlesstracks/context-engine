...
function updateSpoke(graphDir, spokeId, updates) {
  ...
  const allowed = ['name', 'description', 'source', 'external_id', 'sync_status', 'template_type', 'gap_analysis', 'document_classification', 'files', 'shares', 'review_status', 'review_summary'];
