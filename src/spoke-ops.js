...
function updateSpoke(graphDir, spokeId, updates) {
  ...
  const allowed = ['name', 'description', 'source', 'external_id', 'sync_status', 'template_type', 'gap_analysis', 'document_classification', 'files', 'shares', 'review_status', 'review_summary', 'events', 'recent_activity', 'form_state', 'form_submissions', 'conversation_sessions', 'client_type', 'favorited', 'email', 'phone', 'notes', 'entity_type', 'pack_id', 'preferred_name', 'filing_status', 'people', 'affiliations', 'strategies'];
